...
custom_msgs__msg__VehicleCommand__init(custom_msgs__msg__VehicleCommand * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->command)) {
    custom_msgs__msg__VehicleCommand__fini(msg);
    return false;
  }
  // speed
  // angle
...
custom_msgs__msg__VehicleCommand__create(void)
{
  ...
  custom_msgs__msg__VehicleCommand * msg = (custom_msgs__msg__VehicleCommand *)allocator.allocate(sizeof(custom_msgs__msg__VehicleCommand), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(custom_msgs__msg__VehicleCommand));
  bool success = custom_msgs__msg__VehicleCommand__init(msg);
  if (!success) {
...
custom_msgs__msg__VehicleCommand__Sequence__init(custom_msgs__msg__VehicleCommand__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_msgs__msg__VehicleCommand * data = NULL;

  if (size) {
    data = (custom_msgs__msg__VehicleCommand *)allocator.zero_allocate(size, sizeof(custom_msgs__msg__VehicleCommand), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = custom_msgs__msg__VehicleCommand__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        custom_msgs__msg__VehicleCommand__fini(&data[i - 1]);
      }
...
custom_msgs__msg__VehicleCommand__Sequence__fini(custom_msgs__msg__VehicleCommand__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      custom_msgs__msg__VehicleCommand__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_msgs__msg__VehicleCommand__Sequence * array = (custom_msgs__msg__VehicleCommand__Sequence *)allocator.allocate(sizeof(custom_msgs__msg__VehicleCommand__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = custom_msgs__msg__VehicleCommand__Sequence__init(array, size);
  if (!success) {
...
custom_msgs__msg__VehicleCommand__Sequence__destroy(custom_msgs__msg__VehicleCommand__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    custom_msgs__msg__VehicleCommand__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
custom_msgs__msg__VehicleCommand__Sequence__are_equal(const custom_msgs__msg__VehicleCommand__Sequence * lhs, const custom_msgs__msg__VehicleCommand__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!custom_msgs__msg__VehicleCommand__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  custom_msgs__msg__VehicleCommand__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(custom_msgs__msg__VehicleCommand);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    custom_msgs__msg__VehicleCommand * data =
      (custom_msgs__msg__VehicleCommand *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!custom_msgs__msg__VehicleCommand__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          custom_msgs__msg__VehicleCommand__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!custom_msgs__msg__VehicleCommand__copy(
