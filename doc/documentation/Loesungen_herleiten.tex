...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{Images/Expondential Funktion.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{Images/Gaussche Glocke.png}
...
\subsubsection*{Fazit}
Zusammenfassend lässt sich festhalten, dass Parabeln und Exponentialfunktionen aufgrund ihrer globalen Struktur und mangelnden lokalen Anpassungsfähigkeit nur bedingt zur Hindernisumfahrung geeignet sind. Die Gaußsche Glockenkurve hingegen vereint Symmetrie, lokale Begrenzung und hohe Flexibilität. In rekursiver Anwendung stellt sie eine mathematisch elegante und funktionell überlegene Lösung zur Umfahrung beliebiger Gegenstände dar.
